                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="<?php echo url('admin/category')?>" class="btn btn-tool">
                                        <i class="fas fa-chevron-left"></i> Kategori Utama
                                    </a>
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo url('admin/category/save');?>" class="form-ajax">
                        ...
                        <div class="modal-footer justify-content-between">
                            <input type="hidden" id="parent" name="parent" value="<?php echo $submenu;?>">
